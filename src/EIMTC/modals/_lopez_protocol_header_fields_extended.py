...
class LopezExtendedModality:
    '''
    Lopez-Protocol-header-Fields Exteneded deep learning nerual network uses for Packet Header Fields vector input.
    Classifciation type: Packet Header Fields
    Input: two-dimensional vector of number of packets and 6 features from each packet.
