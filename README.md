...
**O**pen-**S**ource **F**ramework for **E**ncrypted **I**nternet and **M**alware **T**raffic **C**lassification.
...
```
But check the offical instructions for more customized options such as for CPU utilization.
